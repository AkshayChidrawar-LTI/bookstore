...
This folder defines all source code for the raw_to_bronze pipeline:
...
* Take a look at the sample under "sample_trips_raw_to_bronze.py" to get familiar with the syntax.
